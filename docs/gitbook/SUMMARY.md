...
* [Documentation map](00-welcome/documentation-map.md)
* [Progress till now](10-progress/progress-till-now.md)
...
* [Architecture section guide](02-architecture/architecture-section-guide.md)
...
* [Backend processes](03-backend/backend-processes.md)
* [Services and modules](03-backend/services-and-modules.md)

## Flows & automation

* [Flows section guide](04-flows/flows-section-guide.md)
* [Flows and logic](04-flows/flows-and-logic.md)
...
* [API section guide](07-api/api-section-guide.md)
* [Agent API and core routes](07-api/agent-api-and-core-routes.md)
...
* [Operations section guide](08-operations/operations-section-guide.md)
* [Security, observability, SLOs](08-operations/security-observability-runbooks.md)
...
* [Archive (design artifacts & notes)](../archive/README.md)
