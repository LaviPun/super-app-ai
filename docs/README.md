...
| [`module-settings-modernization.md`](./archive/module-settings-modernization.md) | Required advanced settings by module type and template installability gates. |
...
- Do not duplicate RecipeSpec or Shopify surface enums outside [`ai-module-main-doc.md`](./ai-module-main-doc.md) and [`superapp-surface-inventory.md`](./archive/superapp-surface-inventory.md).
