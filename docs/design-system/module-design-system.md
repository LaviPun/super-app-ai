...
>
> **Reference build:** `Template Gallery.dc.html` — option **1a** = Minimal Luxe, **1b** = Bold DTC, every template in both.
...
| Team / story / timeline | `contact` | grid · stacked | round avatars, serif names | 2px-framed avatars, caps names |
