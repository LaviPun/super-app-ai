...
| Router Kubernetes manifests | *(removed 2026-06-12)* | Former `deploy/internal-ai-router/` bundle replaced by Docker + Modal + local router; Cloudflare-only policy for V2 deploy. |
