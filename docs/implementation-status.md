...
> Last updated: 2026-05-01 (AI provider split doc: module gen OpenAI+Claude / internal Qwen3 4B; internal AI assistant hardening; `/autoplan` 2026-05-01 review in `phase-plan.md`; shared chat probe; router passthrough; doc alignment).
