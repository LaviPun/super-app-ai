...
export const MODULE_TYPE_TO_TEMPLATE_KIND: Record<ModuleType, string> = {
  ...
  'functions.shippingDiscount': 'shipping_discount',
  'functions.localPickupDeliveryOption': 'local_pickup',
  'functions.pickupPointDeliveryOption': 'pickup_point',
  ...
  'admin.discountUi': 'discount_ui',
  'admin.link': 'admin_link',
  'admin.print': 'admin_print',
  'admin.segmentTemplate': 'segment_template',
...
const MODULE_TYPE_TAGS: Record<ModuleType, readonly string[]> = {
  ...
  'functions.shippingDiscount': ['function', 'shipping', 'delivery', 'discount', 'free-shipping', 'pricing'],
  'functions.localPickupDeliveryOption': ['function', 'pickup', 'local-pickup', 'bopis', 'delivery', 'fulfillment'],
  'functions.pickupPointDeliveryOption': ['function', 'pickup', 'pickup-point', 'parcel-locker', 'delivery', 'fulfillment'],
  ...
  'admin.discountUi': ['admin', 'discount', 'ui', 'pricing'],
  'admin.link': ['admin', 'link', 'deep-link'],
  'admin.print': ['admin', 'print', 'packing-slip', 'invoice', 'label'],
  'admin.segmentTemplate': ['admin', 'segment', 'template', 'customers', 'marketing'],
