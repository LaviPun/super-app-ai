...
export const INTENT_TO_RECIPE_TYPE: Partial<Record<(typeof CLEAN_INTENTS)[number], ModuleType>> = {
  'promo.popup': 'theme.section',
  'promo.banner': 'theme.section',
  'promo.free_shipping_bar': 'theme.section',
  'promo.countdown': 'theme.section',
  ...
  'engage.newsletter_capture': 'theme.section',
  'engage.exit_intent': 'theme.section',
  'engage.survey': 'theme.section',
  'utility.announcement': 'theme.section',
  'utility.effect': 'theme.section',
  'utility.floating_widget': 'theme.section',
