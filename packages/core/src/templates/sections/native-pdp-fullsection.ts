...
export const NSEC_PDP_TEMPLATES: TemplateEntry[] = [
  // ── NSEC-PDP-01 — Loox-style photo review wall ──────────────────────────────
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#111827', background: '#ffffff', seed: '#f5a623', overlayBackdropOpacity: 0.5 },
  ...
  // ── NSEC-PDP-02 — Judge.me-style review widget with rating-distribution header ─
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#1f2937', background: '#ffffff', border: '#e5e7eb', buttonBg: '#111827', buttonText: '#ffffff', seed: '#fbbf24', overlayBackdropOpacity: 0.45 },
  ...
  // ── NSEC-PDP-03 — Testimonial carousel (Loox/Judge.me carousel theme) ─────────
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#0f172a', background: '#f8fafc', seed: '#f5a623', overlayBackdropOpacity: 0.45 },
  ...
  // ── NSEC-PDP-05 — Product add-ons grid (Selleasy card grid) ───────────────────
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#1f2937', background: '#ffffff', border: '#e5e7eb', buttonBg: '#2563eb', buttonText: '#ffffff', overlayBackdropOpacity: 0.45 },
        shape: { radius: 'lg', borderWidth: 'thin', shadow: 'sm', elevation: 'soft' },
        responsive: { hideOnMobile: false, hideOnDesktop: false },
        accessibility: { focusVisible: true, reducedMotion: true },
      },
  ...
  // ── NSEC-PDP-06 — Feature / benefit bento grid ───────────────────────────────
  {
    ...
    type: 'theme.section',
    icon: 'grid',
    tags: ['section', 'features', 'product', 'benefits', 'grid', 'bold-dtc'],
    spec: {
      type: 'theme.section',
      name: 'Feature Highlights — Bento Grid',
      category: 'STOREFRONT_UI',
      ...
      style: {
        ...
        colors: { text: '#0f172a', background: '#0b1220', buttonBg: '#22d3ee', buttonText: '#0b1220', seed: '#22d3ee', overlayBackdropOpacity: 0.5 },
  ...
  // ── NSEC-PDP-07 — Comparison / "why us" table ────────────────────────────────
  {
    ...
    spec: {
      ...
      style: {
        ...
        typography: { size: 'MD', weight: 'normal', lineHeight: 'normal', align: 'left' },
        colors: { text: '#111827', background: '#ffffff', border: '#e5e7eb', seed: '#16a34a', overlayBackdropOpacity: 0.45 },
