  ...
  // ── NSEC-PDP-08 — Product FAQ accordion ──────────────────────────────────────
  {
    ...
    spec: {
      ...
      config: {
        ...
        blocks: [
          { kind: 'faq-item', text: 'How does it fit?', fields: { answer: 'It fits true to size. If you are between sizes, we recommend sizing up for a relaxed fit.' } },
          { kind: 'faq-item', text: 'When will my order arrive?', fields: { answer: 'Orders ship within 1–2 business days. Delivery typically takes 3–5 business days in-country.' } },
          { kind: 'faq-item', text: 'How do I care for it?', fields: { answer: 'Machine wash cold, lay flat to dry. Avoid bleach to keep the color vibrant.' } },
          { kind: 'faq-item', text: 'What is your return policy?', fields: { answer: 'Yes — return or exchange within 30 days for any reason, no questions asked.' } },
        ],
      },
      placement: PRODUCT_ONLY,
      style: {
