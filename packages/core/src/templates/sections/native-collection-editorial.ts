...
export const NATIVE_COLLECTION_EDITORIAL_TEMPLATES: TemplateEntry[] = [
  {
    ...
    type: 'theme.section',
    icon: 'hero',
    tags: ['section', 'collection', 'editorial', 'hero', 'campaign'],
    spec: {
      type: 'theme.section',
      name: 'Collection Editorial Hero',
      category: 'STOREFRONT_UI',
  ...
  },
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { overlayBackdrop: '#000000', overlayBackdropOpacity: 0.25, seed: '#a67c52' },
  ...
  },
  {
    ...
    type: 'theme.section',
    icon: 'columns',
    tags: ['section', 'collection', 'editorial', 'split', 'intro'],
    spec: {
      type: 'theme.section',
      name: 'Collection Split Intro',
      category: 'STOREFRONT_UI',
      ...
      style: {
        ...
        colors: { overlayBackdropOpacity: 0.45, seed: '#9c8466' },
  ...
  },
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { overlayBackdrop: '#0f172a', overlayBackdropOpacity: 0.3, seed: '#1f3a2e' },
        shape: { radius: 'lg', borderWidth: 'none', shadow: 'sm', elevation: 'soft' },
        responsive: { hideOnMobile: false, hideOnDesktop: false },
        accessibility: { focusVisible: true, reducedMotion: true },
  ...
  },
  {
    ...
    type: 'theme.section',
    icon: 'banner',
    tags: ['section', 'collection', 'editorial', 'promo', 'sale'],
    spec: {
      type: 'theme.section',
      name: 'Collection Curated Promo Band',
      category: 'STOREFRONT_UI',
