...
export const NATIVE_FEATURE_BENTO_TEMPLATES: TemplateEntry[] = [
  // 01 — Bento grid, mixed-size tiles, one hero span. Apple-HIG-clean grammar.
  {
    ...
    type: 'theme.section',
    icon: 'grid',
    tags: ['section', 'feature-bento', 'bento', 'features', 'grid', 'index'],
    spec: {
      type: 'theme.section',
      name: 'Feature Bento — Mixed-Size Grid',
      category: 'STOREFRONT_UI',
      ...
      style: {
        ...
        colors: { overlayBackdropOpacity: 0.45, seed: '#0891b2' },
  ...
  // 02 — Masonry bento, staggered tiles, imagery-led. Editorial-wellness grammar.
  {
    ...
    type: 'theme.section',
    icon: 'grid',
    tags: ['section', 'feature-bento', 'bento', 'features', 'masonry'],
    spec: {
      type: 'theme.section',
      ...
      style: {
        ...
        colors: { seed: '#8a7f70', overlayBackdropOpacity: 0.45 },
  ...
  // 03 — Bold-DTC bento, saturated accent on dark, one hero tile + group-hover glow.
  {
    ...
    type: 'theme.section',
    icon: 'grid',
    tags: ['section', 'feature-bento', 'bento', 'features', 'grid'],
    spec: {
      type: 'theme.section',
      name: 'Feature Bento — Dark, Accent Hero',
      category: 'STOREFRONT_UI',
      ...
      style: {
        ...
        colors: { text: '#f8fafc', background: '#0b0b0f', seed: '#ff4d2e', overlayBackdropOpacity: 0.45 },
  ...
  // 04 — Minimal-luxe bento, near-mono, tight radius, embossed material, duotone tiles.
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { seed: '#9c8f7a', overlayBackdropOpacity: 0.45 },
  ...
  // 05 — Playful-commerce bento, rounded pastel tiles, icon-forward, self-advancing feel.
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { seed: '#7c5cff', overlayBackdropOpacity: 0.45 },
  ...
  // 06 — Feature COLUMNS: even 3-up, icon-over-copy, tech-utility grammar (hairline, dense).
  {
    ...
    type: 'theme.section',
    icon: 'grid',
    tags: ['section', 'feature-columns', 'features', 'grid', 'value-props'],
    spec: {
      type: 'theme.section',
      ...
      style: {
        ...
        colors: { text: '#e5e7eb', background: '#0d1117', seed: '#3b82f6', overlayBackdropOpacity: 0.45 },
  ...
  // 08 — Feature COLUMNS as a horizontal carousel (mobile-first scroll-snap row of tiles).
  {
    ...
    type: 'theme.section',
    icon: 'grid',
    tags: ['section', 'feature-columns', 'features', 'carousel', 'mobile'],
    spec: {
      type: 'theme.section',
