...
export const NATIVE_CONTACT_TEAM_TIMELINE_TEMPLATES: TemplateEntry[] = [
  // ── Contact / map — variant 1: split (map left, address + inline email right) ──
  {
    ...
    type: 'theme.section',
    icon: 'contact',
    tags: ['section', 'contact', 'map', 'page', 'apple-hig', 'split'],
    spec: {
      type: 'theme.section',
      name: 'Contact — Split Map & Details',
      category: 'STOREFRONT_UI',
  ...
  // ── Contact / map — variant 2: stacked (centered form over full-width map) ──
  {
    ...
    type: 'theme.section',
    icon: 'contact',
    tags: ['section', 'contact', 'map', 'page', 'stacked', 'apple-hig'],
    spec: {
      type: 'theme.section',
      name: 'Contact — Stacked Form Over Map',
      category: 'STOREFRONT_UI',
      ...
      style: {
        ...
        colors: { text: '#0f172a', background: '#f6f8fb', buttonBg: '#0f172a', buttonText: '#ffffff', overlayBackdropOpacity: 0.45 },
  ...
  // ── Contact / map — variant 3: card grid (method cards, no form) ──
  {
    ...
    type: 'theme.section',
    icon: 'contact',
    tags: ['section', 'contact', 'grid', 'page', 'card', 'apple-hig'],
    spec: {
      type: 'theme.section',
      name: 'Contact — Method Cards',
      category: 'STOREFRONT_UI',
  ...
  // ── Team — variant 4: portrait grid (staff cards with role + socials) ──
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#1c1917', background: '#faf9f7', overlayBackdropOpacity: 0.45 },
  ...
  // ── Team — variant 5: horizontal roster carousel (larger teams) ──
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#1c1917', background: '#ffffff', overlayBackdropOpacity: 0.45 },
        shape: { radius: 'lg', borderWidth: 'none', shadow: 'sm', elevation: 'soft' },
        responsive: { hideOnMobile: false, hideOnDesktop: false },
        accessibility: { focusVisible: true, reducedMotion: true },
  ...
  // ── Timeline — variant 6: vertical milestone story (brand history) ──
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#1c1917', background: '#faf9f7', overlayBackdropOpacity: 0.45, seed: '#8b7355' },
  ...
  // ── How-to steps — variant 7: numbered vertical steps (setup / how-it-works) ──
  {
    ...
    type: 'theme.section',
    icon: 'steps',
    tags: ['section', 'how-to', 'steps', 'page', 'product', 'apple-hig'],
    spec: {
      type: 'theme.section',
      name: 'How It Works — Numbered Steps',
      category: 'STOREFRONT_UI',
  ...
  // ── How-to steps — variant 8: horizontal process strip (dense, tech-utility) ──
  {
    ...
    type: 'theme.section',
    icon: 'steps',
    tags: ['section', 'how-to', 'steps', 'grid', 'page', 'tech-utility'],
    spec: {
      type: 'theme.section',
      name: 'How It Works — Horizontal Process Strip',
      category: 'STOREFRONT_UI',
