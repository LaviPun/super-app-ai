...
export const NEWSLETTER_CAPTURE_SECTION_TEMPLATES: TemplateEntry[] = [
  // NSEC-NEWS-01 — Privy-style inline embedded capture (scroll box → inline block), homepage.
  {
    ...
    type: 'theme.section',
    icon: 'newsletter',
    tags: ['section', 'newsletter', 'email-capture', 'privy', 'index', 'bold-dtc'],
    spec: {
      type: 'theme.section',
      name: 'Newsletter — Inline Embedded Capture',
      category: 'STOREFRONT_UI',
      ...
      style: {
        ...
        colors: { text: '#0f172a', background: '#ffffff', buttonBg: '#111827', buttonText: '#ffffff', seed: '#111827', overlayBackdropOpacity: 0.45 },
  ...
  // NSEC-NEWS-02 — Split-image editorial capture (Klaviyo side-image form), page surface.
  {
    ...
    type: 'theme.section',
    icon: 'newsletter',
    tags: ['section', 'newsletter', 'email-capture', 'klaviyo', 'page', 'editorial-wellness'],
    spec: {
      type: 'theme.section',
      name: 'Newsletter — Split Image Capture',
      category: 'STOREFRONT_UI',
      ...
      style: {
        ...
        colors: { text: '#2b2b28', background: '#f6f4ef', buttonBg: '#2b2b28', buttonText: '#f6f4ef', border: '#d8d3c8', seed: '#7d745f', overlayBackdropOpacity: 0.45 },
  ...
  // NSEC-NEWS-03 — Footer newsletter strip (Klaviyo "Embedded Form in Footer" pattern).
  {
    ...
    type: 'theme.section',
    icon: 'newsletter',
    tags: ['section', 'newsletter', 'email-capture', 'klaviyo', 'footer', 'tech-utility'],
    spec: {
      type: 'theme.section',
      name: 'Newsletter — Footer Strip',
      category: 'STOREFRONT_UI',
      ...
      style: {
        ...
        colors: { text: '#e5e7eb', background: '#0b0f19', buttonBg: '#3b82f6', buttonText: '#ffffff', border: '#1f2937', seed: '#3b82f6', overlayBackdropOpacity: 0.45 },
  ...
  // NSEC-NEWS-04 — Multi-step email → SMS capture (Klaviyo/Privy multi-step form, blocks = steps).
  {
    ...
    spec: {
      ...
      style: {
        ...
        spacing: { padding: 'loose', margin: 'none', gap: 'medium', density: 'comfortable' },
        typography: { size: 'LG', weight: 'bold', lineHeight: 'normal', align: 'center' },
        colors: { text: '#111111', background: '#ffffff', buttonBg: '#111111', buttonText: '#ffffff', seed: '#6d28d9', overlayBackdropOpacity: 0.45 },
  ...
  // NSEC-NEWS-05 — Popup-style centered capture card (Privy/Omnisend popup rendered in-body).
  {
    ...
    type: 'theme.section',
    icon: 'newsletter',
    tags: ['section', 'newsletter', 'email-capture', 'privy', 'omnisend', 'playful-commerce'],
    spec: {
      type: 'theme.section',
      name: 'Newsletter — Popup-Style Welcome Card',
      category: 'STOREFRONT_UI',
      ...
      style: {
        ...
        colors: { text: '#1f1147', background: '#fdf2f8', buttonBg: '#db2777', buttonText: '#ffffff', border: '#fbcfe8', seed: '#db2777', overlayBackdrop: '#1f1147', overlayBackdropOpacity: 0.55 },
  ...
  // NSEC-NEWS-06 — Blog/article inline capture with trust badges (Omnisend inline + legal-consent block).
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#111827', background: '#f9fafb', buttonBg: '#059669', buttonText: '#ffffff', border: '#e5e7eb', seed: '#059669', overlayBackdropOpacity: 0.45 },
  ...
  // NSEC-NEWS-07 — Minimal-luxe centered single-field capture (Editorial/Minimal-Luxe, homepage hero band).
  {
    ...
    description:
      'Restrained centered single-line capture band for the homepage — hairline underline field, one word CTA, near-mono palette. Minimal-luxe newsletter variant.',
    category: 'STOREFRONT_UI',
    type: 'theme.section',
    icon: 'newsletter',
    tags: ['section', 'newsletter', 'email-capture', 'minimal-luxe', 'index', 'centered'],
    spec: {
      type: 'theme.section',
      name: 'Newsletter — Minimal Centered Capture',
      category: 'STOREFRONT_UI',
      ...
      style: {
        ...
        colors: { text: '#141414', background: '#ffffff', buttonBg: '#141414', buttonText: '#ffffff', border: '#141414', seed: '#8a8a8a', overlayBackdropOpacity: 0.45 },
  ...
  // NSEC-NEWS-08 — Benefit-grid capture with value props (Privy/Omnisend benefit blocks), page surface.
  {
    ...
    spec: {
      ...
      style: {
        ...
        spacing: { padding: 'loose', margin: 'none', gap: 'medium', density: 'comfortable' },
        typography: { size: 'LG', weight: 'bold', lineHeight: 'normal', align: 'center' },
        colors: { text: '#0f172a', background: '#ffffff', buttonBg: '#2563eb', buttonText: '#ffffff', border: '#e2e8f0', seed: '#2563eb', overlayBackdropOpacity: 0.45 },
        shape: { radius: 'lg', borderWidth: 'thin', shadow: 'sm', elevation: 'soft' },
        responsive: { hideOnMobile: false, hideOnDesktop: false },
        accessibility: { focusVisible: true, reducedMotion: true },
        motion: { duration: 'base', easing: 'standard' },
