  ...
  // ── 01 · Loox — dynamic photo-review wall (reviews) ────────────────────────
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#111827', background: '#ffffff', seed: '#f5a623', overlayBackdropOpacity: 0.45 },
  ...
  // ── 02 · Okendo — reviews + Q&A widget (reviews) ───────────────────────────
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#1f2937', background: '#ffffff', seed: '#111111', overlayBackdropOpacity: 0.45 },
  ...
  // ── 04 · Rebuy — cart cross-sell recommendations (recs, cart) ──────────────
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#0f172a', background: '#f8fafc', buttonBg: '#111827', buttonText: '#ffffff', overlayBackdropOpacity: 0.45 },
        shape: { radius: 'md', borderWidth: 'thin', shadow: 'none', elevation: 'border' },
        responsive: { hideOnMobile: false, hideOnDesktop: false },
        accessibility: { focusVisible: true, reducedMotion: true },
      },
  ...
  // ── 05 · Selleasy — Frequently Bought Together (recs) ──────────────────────
  {
    ...
    spec: {
      ...
      style: {
        ...
        spacing: { padding: 'loose', margin: 'none', gap: 'medium', density: 'comfortable' },
        typography: { size: 'MD', weight: 'medium', lineHeight: 'normal', align: 'left' },
        colors: { text: '#111827', background: '#ffffff', buttonBg: '#f59e0b', buttonText: '#111827', overlayBackdropOpacity: 0.45 },
  ...
  // ── 06 · Swym — wishlist button (wishlist, product) ────────────────────────
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#111827', background: '#ffffff', border: '#e5e7eb', buttonBg: '#111827', buttonText: '#ffffff', overlayBackdropOpacity: 0.45 },
  ...
  // ── 07 · Swym — wishlist page / drawer (wishlist) ──────────────────────────
  {
    ...
    spec: {
      ...
      style: {
        ...
        spacing: { padding: 'loose', margin: 'none', gap: 'medium', density: 'comfortable' },
        typography: { size: 'LG', weight: 'bold', lineHeight: 'normal', align: 'left' },
        colors: { text: '#111827', background: '#ffffff', buttonBg: '#111827', buttonText: '#ffffff', overlayBackdropOpacity: 0.45 },
        shape: { radius: 'md', borderWidth: 'none', shadow: 'sm', elevation: 'soft' },
        responsive: { hideOnMobile: false, hideOnDesktop: false },
        accessibility: { focusVisible: true, reducedMotion: true },
      },
  ...
  // ── 08 · LoyaltyLion — loyalty launcher / panel (loyalty) ──────────────────
  {
    ...
    spec: {
      ...
      style: {
        ...
        spacing: { padding: 'loose', margin: 'none', gap: 'medium', density: 'comfortable' },
        typography: { size: 'MD', weight: 'medium', lineHeight: 'normal', align: 'left' },
        colors: { text: '#1e1b4b', background: '#ffffff', seed: '#4f46e5', buttonBg: '#4f46e5', buttonText: '#ffffff', overlayBackdropOpacity: 0.45 },
  ...
  // ── 10 · Appikon — back-in-stock "Notify Me" widget (back-in-stock) ────────
  {
    ...
    spec: {
      ...
      style: {
        ...
        spacing: { padding: 'medium', margin: 'none', gap: 'tight', density: 'compact' },
        typography: { size: 'MD', weight: 'medium', lineHeight: 'normal', align: 'left' },
        colors: { text: '#111827', background: '#ffffff', border: '#d1d5db', buttonBg: '#111827', buttonText: '#ffffff', overlayBackdropOpacity: 0.45 },
        shape: { radius: 'md', borderWidth: 'thin', shadow: 'none', elevation: 'border' },
        responsive: { hideOnMobile: false, hideOnDesktop: false },
        accessibility: { focusVisible: true, reducedMotion: true },
      },
