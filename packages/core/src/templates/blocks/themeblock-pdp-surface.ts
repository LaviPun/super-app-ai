...
export const templates: TemplateEntry[] = [
  ...
  },
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#6b7280', background: '#ffffff', overlayBackdropOpacity: 0.45 },
  ...
  },
  {
    ...
    description:
      'Monochrome guarantee-badge grid for premium/minimal themes — single-color icon cards for quality, returns, and support, styled black-and-white to match the store.',
    category: 'STOREFRONT_UI',
    type: 'theme.section',
    icon: 'shield',
    tags: ['hextom', 'trust-badge', 'product', 'grid', 'minimal-luxe', 'guarantee'],
    spec: {
      type: 'theme.section',
      name: 'Guarantee Badge Grid (Mono)',
      category: 'STOREFRONT_UI',
      ...
      style: {
        ...
        colors: { text: '#1a1a1a', background: '#ffffff', border: '#1a1a1a', overlayBackdropOpacity: 0.45 },
  ...
  },
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#111827', background: '#ffffff', overlayBackdrop: '#000000', overlayBackdropOpacity: 0.55 },
  ...
  // ── Bought-together / add-ons (Selleasy) ──────────────────────────────────
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#111827', background: '#ffffff', buttonBg: '#111827', buttonText: '#ffffff', border: '#e5e7eb', overlayBackdropOpacity: 0.45 },
  ...
  },
  {
    ...
    spec: {
      ...
      style: {
        ...
        spacing: { padding: 'medium', margin: 'none', gap: 'tight', density: 'comfortable' },
        typography: { size: 'MD', weight: 'normal', lineHeight: 'normal', align: 'left' },
        colors: { text: '#111827', background: '#f9fafb', border: '#e5e7eb', overlayBackdropOpacity: 0.45 },
        shape: { radius: 'md', borderWidth: 'thin', shadow: 'none' },
        responsive: { hideOnMobile: false, hideOnDesktop: false },
        accessibility: { focusVisible: true, reducedMotion: true },
      },
  ...
  },
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#ffffff', background: '#111827', buttonBg: '#111827', buttonText: '#ffffff', overlayBackdropOpacity: 0.45 },
  ...
  // ── Review summary / rating (Loox · Judge.me · Okendo) ────────────────────
  {
    ...
    spec: {
      ...
      style: {
        ...
        spacing: { padding: 'medium', margin: 'none', gap: 'tight', density: 'comfortable' },
        typography: { size: 'MD', weight: 'normal', lineHeight: 'normal', align: 'left' },
        colors: { text: '#111827', background: '#ffffff', border: '#e5e7eb', seed: '#f5a623', overlayBackdropOpacity: 0.45 },
        shape: { radius: 'md', borderWidth: 'thin', shadow: 'none' },
        responsive: { hideOnMobile: false, hideOnDesktop: false },
        accessibility: { focusVisible: true, reducedMotion: true },
      },
  ...
  },
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#374151', background: '#ffffff', seed: '#f5a623', overlayBackdropOpacity: 0.45 },
