  ...
  // 01 — Privy centered email-capture popup with coupon reveal (exit-intent).
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#111827', background: '#ffffff', buttonBg: '#111827', buttonText: '#ffffff', overlayBackdrop: '#000000', overlayBackdropOpacity: 0.6, seed: '#111827' },
  ...
  // 02 — Privy top announcement / free-shipping bar (persistent, site-wide).
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#ffffff', background: '#111827', buttonBg: '#ffffff', buttonText: '#111827', overlayBackdropOpacity: 0.45, seed: '#111827' },
  ...
  // 03 — Privy spin-to-win wheel (gamified email capture overlay).
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#1f2937', background: '#fef3c7', buttonBg: '#d97706', buttonText: '#ffffff', overlayBackdrop: '#000000', overlayBackdropOpacity: 0.65, seed: '#d97706' },
  ...
  // 04 — Justuno exit-intent lightbox popup with discount.
  {
    ...
    spec: {
      ...
      style: {
        ...
        spacing: { padding: 'loose', margin: 'none', gap: 'medium', density: 'comfortable' },
        typography: { size: 'LG', weight: 'bold', lineHeight: 'normal', align: 'center' },
        colors: { text: '#0f172a', background: '#ffffff', buttonBg: '#2563eb', buttonText: '#ffffff', overlayBackdrop: '#0f172a', overlayBackdropOpacity: 0.7, seed: '#2563eb' },
  ...
  // 05 — Justuno corner slide-in / flyout email capture.
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#111827', background: '#ffffff', buttonBg: '#111827', buttonText: '#ffffff', border: '#e5e7eb', overlayBackdropOpacity: 0.45, seed: '#2563eb' },
  ...
  // 07 — ProveSource sales-pop toast (social proof stream).
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#111827', background: '#ffffff', border: '#e5e7eb', overlayBackdropOpacity: 0.45, seed: '#10b981' },
  ...
  // 08 — ProveSource live-visitor counter pill (persistent badge).
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#065f46', background: '#ecfdf5', border: '#a7f3d0', overlayBackdropOpacity: 0.45, seed: '#10b981' },
  ...
  // 09 — Swym wishlist launch-point floating button (persistent FAB).
  {
    ...
    spec: {
      ...
      style: {
        ...
        spacing: { padding: 'tight', margin: 'none', gap: 'none', density: 'compact' },
        typography: { size: 'SM', weight: 'medium', lineHeight: 'normal', align: 'center' },
        colors: { text: '#ffffff', background: '#e11d48', buttonBg: '#e11d48', buttonText: '#ffffff', overlayBackdropOpacity: 0.45, seed: '#e11d48' },
  ...
  // 10 — Appikon back-in-stock "Notify Me" overlay form.
  {
    ...
    spec: {
      ...
      style: {
        ...
        spacing: { padding: 'loose', margin: 'none', gap: 'medium', density: 'comfortable' },
        typography: { size: 'MD', weight: 'medium', lineHeight: 'normal', align: 'left' },
        colors: { text: '#111827', background: '#ffffff', buttonBg: '#111827', buttonText: '#ffffff', overlayBackdrop: '#000000', overlayBackdropOpacity: 0.55, seed: '#111827' },
        shape: { radius: 'lg', borderWidth: 'none', shadow: 'lg', elevation: 'soft' },
        responsive: { hideOnMobile: false, hideOnDesktop: false },
        accessibility: { focusVisible: true, reducedMotion: true },
        motion: { duration: 'base', easing: 'enter' },
