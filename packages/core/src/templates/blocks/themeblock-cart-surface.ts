  ...
  // ── TBLK-CART-01 — Free-shipping goal bar (UpCart tiered-rewards progress) ──
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#111827', background: '#f3f4f6', border: '#e5e7eb', seed: '#16a34a', overlayBackdropOpacity: 0.45 },
  ...
  // ── TBLK-CART-02 — Tiered rewards ladder (UpCart 3-tier rewards bar) ──
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#111827', background: '#ffffff', border: '#e5e7eb', seed: '#7c3aed', overlayBackdropOpacity: 0.45 },
  ...
  // ── TBLK-CART-03 — Cart goal → free gift (Corner slide-cart free-gift) ──
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#1f2937', background: '#fdf2f8', border: '#fbcfe8', seed: '#db2777', overlayBackdropOpacity: 0.45 },
  ...
  // ── TBLK-CART-05 — Cart add-ons / bundle (Selleasy cart add-ons, add-all) ──
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#111827', background: '#ffffff', border: '#e5e7eb', buttonBg: '#2563eb', buttonText: '#ffffff', overlayBackdropOpacity: 0.45 },
  ...
  // ── TBLK-CART-07 — Reserved-cart urgency timer (Hextom reserved-cart timer) ──
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#7f1d1d', background: '#fef2f2', border: '#fecaca', seed: '#dc2626', overlayBackdropOpacity: 0.45 },
        shape: { radius: 'md', borderWidth: 'thin', shadow: 'none', elevation: 'border' },
        responsive: { hideOnMobile: false, hideOnDesktop: false },
