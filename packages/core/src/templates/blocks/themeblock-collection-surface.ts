...
export const templates: TemplateEntry[] = [
  // TBLK-COL-01 — Faceted filter sidebar (Boost / Shopify Search & Discovery vertical sidebar).
  {
    ...
    type: 'theme.section',
    icon: 'filter',
    tags: ['section', 'filters', 'faceted', 'collection', 'search', 'boost', 'apple-hig-clean'],
    spec: {
      type: 'theme.section',
      name: 'Faceted Filter Sidebar',
      category: 'STOREFRONT_UI',
      ...
      style: {
        ...
        colors: { text: '#111827', background: '#ffffff', border: '#e2e8f0', overlayBackdropOpacity: 0.45, seed: '#2563eb' },
  ...
  // TBLK-COL-02 — Horizontal filter bar + drawer (Boost horizontal / off-canvas layout).
  {
    ...
    type: 'theme.section',
    icon: 'filter',
    tags: ['section', 'filters', 'horizontal', 'drawer', 'collection', 'boost', 'tech-utility'],
    spec: {
      type: 'theme.section',
      name: 'Horizontal Filter Bar',
      category: 'STOREFRONT_UI',
      ...
      style: {
        ...
        typography: { size: 'SM', weight: 'medium', lineHeight: 'normal', align: 'left' },
        colors: { text: '#0f172a', background: '#ffffff', border: '#dce3ec', overlayBackdropOpacity: 0.5, seed: '#0f172a' },
  ...
  // TBLK-COL-03 — Sort dropdown / toolbar (Boost + S&D default sort orders).
  {
    ...
    type: 'theme.section',
    icon: 'sort',
    tags: ['section', 'sort', 'toolbar', 'collection', 'search', 'boost', 'apple-hig-clean'],
    spec: {
      type: 'theme.section',
      name: 'Sort & Result Toolbar',
      category: 'STOREFRONT_UI',
      ...
      style: {
        ...
        colors: { text: '#334155', background: '#ffffff', border: '#e2e8f0', overlayBackdropOpacity: 0.45, seed: '#2563eb' },
  ...
  // TBLK-COL-04 — Collection promo banner (Discount Ninja product banner / Hextom promo message).
  {
    ...
    description: 'Full-width promo banner above the collection grid — sale headline, savings copy, and a CTA. Bold-DTC accent ground for flash sales and seasonal drops.',
    category: 'STOREFRONT_UI',
    type: 'theme.section',
    icon: 'banner',
    tags: ['section', 'promo', 'banner', 'sale', 'collection', 'discount-ninja', 'bold-dtc'],
    spec: {
      type: 'theme.section',
      name: 'Collection Promo Banner',
      category: 'STOREFRONT_UI',
      ...
      style: {
        ...
        colors: { text: '#ffffff', background: '#111827', buttonBg: '#f5a623', buttonText: '#111827', overlayBackdropOpacity: 0.5, seed: '#f5a623' },
  ...
  // TBLK-COL-05 — Tiered free-shipping / spend-goal bar (Discount Ninja "add X more to unlock").
  {
    ...
    type: 'theme.section',
    icon: 'progress',
    tags: ['section', 'promo', 'free-shipping', 'aov', 'collection', 'discount-ninja', 'playful-commerce'],
    spec: {
      type: 'theme.section',
      name: 'Spend-Goal Progress Bar',
      category: 'STOREFRONT_UI',
      ...
      style: {
        ...
        colors: { text: '#0f172a', background: '#f6f8fb', buttonBg: '#16a34a', buttonText: '#ffffff', overlayBackdropOpacity: 0.45, seed: '#16a34a' },
  ...
  // TBLK-COL-06 — Promotional badge overlay for PLP cards (Discount Ninja badge / Hextom sticker).
  {
    ...
    type: 'theme.section',
    icon: 'badge',
    tags: ['section', 'badge', 'sticker', 'merchandising', 'collection', 'discount-ninja', 'bold-dtc'],
    spec: {
      type: 'theme.section',
      name: 'Product Card Badge Overlay',
      category: 'STOREFRONT_UI',
  ...
  // TBLK-COL-07 — Search results "no results" fallback (Boost InstantSearch no-result behavior).
  {
    ...
    type: 'theme.section',
    icon: 'search',
    tags: ['section', 'search', 'no-results', 'fallback', 'boost', 'editorial-wellness'],
    spec: {
      type: 'theme.section',
      name: 'Search No-Results Fallback',
      category: 'STOREFRONT_UI',
      ...
      style: {
        ...
        colors: { text: '#1f2937', background: '#ffffff', border: '#e2e8f0', overlayBackdropOpacity: 0.45, seed: '#64748b' },
  ...
  // TBLK-COL-08 — Collection intro / editorial header (S&D collection header pattern).
  {
    ...
    type: 'theme.section',
    icon: 'header',
    tags: ['section', 'collection', 'editorial', 'header', 'gempages', 'editorial-wellness'],
    spec: {
      type: 'theme.section',
      name: 'Collection Intro Header',
      category: 'STOREFRONT_UI',
      ...
      style: {
        ...
        colors: { text: '#1c1917', background: '#faf9f7', border: '#e7e5e4', overlayBackdropOpacity: 0.45, seed: '#78716c' },
  ...
  // TBLK-COL-09 — Trust + payment badge row (Hextom trust badges / payment badges on PLP).
  {
    ...
    type: 'theme.section',
    icon: 'trust',
    tags: ['section', 'trust', 'badges', 'social-proof', 'collection', 'hextom', 'minimal-luxe'],
    spec: {
      type: 'theme.section',
      name: 'Collection Trust Badge Row',
      category: 'STOREFRONT_UI',
      ...
      style: {
        ...
        typography: { size: 'SM', weight: 'medium', lineHeight: 'normal', align: 'center' },
        colors: { text: '#1a1a1a', background: '#ffffff', border: '#eeeeee', overlayBackdropOpacity: 0.45, seed: '#1a1a1a' },
  ...
  // TBLK-COL-10 — Category tile grid for the list-collections page (S&D / merchandising).
  {
    ...
    type: 'theme.section',
    icon: 'grid',
    tags: ['section', 'collection', 'category', 'navigation', 'list-collections', 'apple-hig-clean'],
    spec: {
      type: 'theme.section',
      name: 'Category Tile Grid',
      category: 'STOREFRONT_UI',
      ...
      style: {
        ...
        colors: { text: '#ffffff', background: '#ffffff', overlayBackdrop: '#000000', overlayBackdropOpacity: 0.3, seed: '#2563eb' },
