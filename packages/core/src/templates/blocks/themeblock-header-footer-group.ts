...
export const TEMPLATES: TemplateEntry[] = [
  // ─── Announcement / countdown bars (header group) ───────────────────────────
  {
    ...
    type: 'theme.section',
    icon: 'megaphone',
    tags: ['section', 'announcement', 'header', 'promo', 'bold-dtc', 'bar'],
    spec: {
      type: 'theme.section',
      name: 'Announcement Bar — Static Message',
      category: 'STOREFRONT_UI',
      ...
      style: {
        ...
        colors: { text: '#ffffff', background: '#111827', buttonBg: '#f5a623', buttonText: '#111827', seed: '#111827', overlayBackdropOpacity: 0.45 },
  ...
  },
  {
    ...
    spec: {
      ...
      style: {
        ...
        spacing: { padding: 'tight', margin: 'none', gap: 'tight', density: 'compact' },
        typography: { size: 'SM', weight: 'medium', lineHeight: 'normal', align: 'center' },
        colors: { text: '#111827', background: '#f6f8fb', seed: '#f5a623', overlayBackdropOpacity: 0.45 },
  ...
  },
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#ffffff', background: '#b91c1c', buttonBg: '#ffffff', buttonText: '#b91c1c', seed: '#b91c1c', overlayBackdropOpacity: 0.45 },
  ...
  },
  {
    ...
    spec: {
      ...
      style: {
        ...
        spacing: { padding: 'tight', margin: 'none', gap: 'medium', density: 'compact' },
        typography: { size: 'SM', weight: 'medium', lineHeight: 'normal', align: 'center' },
        colors: { text: '#0f172a', background: '#fde68a', buttonBg: '#0f172a', buttonText: '#fde68a', seed: '#f59e0b', overlayBackdropOpacity: 0.45 },
        shape: { radius: 'none', borderWidth: 'thin', shadow: 'none', elevation: 'border' },
        responsive: { hideOnMobile: false, hideOnDesktop: false },
        accessibility: { focusVisible: true, reducedMotion: true },
        motion: { duration: 'base', easing: 'standard' },
  ...
  },
  {
    ...
    description:
      'A dismissible header bar with a single tappable message (Hextom "make entire bar clickable" mode) that remembers dismissal per visitor — quiet, minimal-luxe styling.',
    category: 'STOREFRONT_UI',
    type: 'theme.section',
    icon: 'megaphone',
    tags: ['section', 'announcement', 'header', 'dismissible', 'minimal-luxe', 'bar'],
    spec: {
      type: 'theme.section',
      ...
      style: {
        ...
        colors: { text: '#3f3a34', background: '#f4f1ec', seed: '#8a7d6b', overlayBackdropOpacity: 0.45 },
        shape: { radius: 'none', borderWidth: 'thin', shadow: 'none', elevation: 'border' },
        responsive: { hideOnMobile: false, hideOnDesktop: false },
        accessibility: { focusVisible: true, reducedMotion: true },
      },
  ...
  // ─── USP / trust / payment strips ───────────────────────────────────────────
  {
    ...
    spec: {
      ...
      style: {
        ...
        typography: { size: 'SM', weight: 'medium', lineHeight: 'normal', align: 'center' },
        colors: { text: '#111827', background: '#ffffff', seed: '#111827', overlayBackdropOpacity: 0.45 },
  ...
  },
  {
    ...
    spec: {
      ...
      style: {
        ...
        typography: { size: 'XS', weight: 'normal', lineHeight: 'normal', align: 'center' },
        colors: { text: '#475569', background: '#f6f8fb', seed: '#111827', overlayBackdropOpacity: 0.45 },
  ...
  },
  {
    ...
    spec: {
      ...
      style: {
        ...
        typography: { size: 'XS', weight: 'normal', lineHeight: 'normal', align: 'center' },
        colors: { text: '#94a3b8', background: '#ffffff', seed: '#111827', overlayBackdropOpacity: 0.45 },
  ...
  },
  {
    ...
    spec: {
      ...
      style: {
        ...
        spacing: { padding: 'tight', margin: 'none', gap: 'tight', density: 'compact' },
        typography: { size: 'SM', weight: 'medium', lineHeight: 'normal', align: 'center' },
        colors: { text: '#065f46', background: '#ecfdf5', buttonBg: '#059669', buttonText: '#ffffff', seed: '#059669', overlayBackdropOpacity: 0.45 },
        shape: { radius: 'none', borderWidth: 'thin', shadow: 'none', elevation: 'border' },
        responsive: { hideOnMobile: false, hideOnDesktop: false },
        accessibility: { focusVisible: true, reducedMotion: true },
        motion: { duration: 'base', easing: 'standard' },
  ...
  // ─── Newsletter footer capture ──────────────────────────────────────────────
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#111827', background: '#ffffff', buttonBg: '#111827', buttonText: '#ffffff', border: '#dce3ec', seed: '#111827', overlayBackdropOpacity: 0.45 },
  ...
  },
  {
    ...
    description:
      'A two-column footer newsletter block — lifestyle image beside an email form (Klaviyo side-image form pattern) with a discount incentive; editorial, imagery-led styling.',
    category: 'STOREFRONT_UI',
    type: 'theme.section',
    icon: 'mail',
    tags: ['section', 'newsletter', 'footer', 'email-capture', 'editorial-wellness', 'klaviyo'],
    spec: {
      type: 'theme.section',
      name: 'Newsletter Footer — Split Image Signup',
      category: 'STOREFRONT_UI',
      ...
      style: {
        ...
        colors: { text: '#2d2a26', background: '#f4f1ec', buttonBg: '#2d2a26', buttonText: '#f4f1ec', seed: '#8a7d6b', overlayBackdropOpacity: 0.45 },
  ...
  },
  {
    ...
    spec: {
      ...
      style: {
        ...
        spacing: { padding: 'loose', margin: 'none', gap: 'medium', density: 'comfortable' },
        typography: { size: 'MD', weight: 'normal', lineHeight: 'normal', align: 'center' },
        colors: { text: '#f8fafc', background: '#111827', buttonBg: '#38bdf8', buttonText: '#0f172a', border: '#334155', seed: '#38bdf8', overlayBackdropOpacity: 0.45 },
        shape: { radius: 'md', borderWidth: 'thin', shadow: 'none', elevation: 'border' },
        responsive: { hideOnMobile: false, hideOnDesktop: false },
        accessibility: { focusVisible: true, reducedMotion: true },
      },
  ...
  },
  {
    ...
    spec: {
      ...
      style: {
        ...
        colors: { text: '#e2e8f0', background: '#0f172a', buttonBg: '#f5a623', buttonText: '#0f172a', border: '#1e293b', seed: '#f5a623', overlayBackdropOpacity: 0.45 },
        shape: { radius: 'none', borderWidth: 'none', shadow: 'none' },
        responsive: { hideOnMobile: false, hideOnDesktop: false },
        accessibility: { focusVisible: true, reducedMotion: true },
      },
