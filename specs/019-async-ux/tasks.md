...
- [x] T001 Review Phase 19 acceptance criteria in migration plan
...
- [ ] T004 Implement phase deliverables — **scaffold only**; async UX demo components + job status API shipped; merchant cutover UX open
