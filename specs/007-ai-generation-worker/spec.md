# Feature Specification: Platform V2 Phase 7 — AI Generation Worker

**Feature Directory**: `007-ai-generation-worker`
...
**Canonical plan**: [`platform-v2-migration-plan.md`](../../docs/gitbook/02-architecture/platform-v2-migration-plan.md) — Phase 7

## Goal

Move AI_GENERATE/HYDRATE/MODIFY to worker; Fastify returns 202; evals pass; RecipeSpec trust boundary.
...
See Phase 7 in [`platform-v2-migration-plan.md`](../../docs/gitbook/02-architecture/platform-v2-migration-plan.md) for full acceptance criteria.
