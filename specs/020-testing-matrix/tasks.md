...
- [x] T001 Review Phase 20 acceptance criteria in migration plan
...
- [ ] T004 Implement phase deliverables — **scaffold only**; package tests green; cross-service matrix pending
