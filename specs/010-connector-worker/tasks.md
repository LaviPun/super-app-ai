# Tasks: Phase 10 — Connector Worker
...
- [x] T001 Review Phase 10 acceptance criteria in migration plan
...
- [ ] T004 Implement phase deliverables — **scaffold only**; minimal handler shipped; acceptance criteria open
