# Feature Specification: Platform V2 Phase 11 — Publish Worker

**Feature Directory**: `011-publish-worker`
...
**Canonical plan**: [`platform-v2-migration-plan.md`](../../docs/gitbook/02-architecture/platform-v2-migration-plan.md) — Phase 11

## Goal

Async publish via worker; idempotent deploy; compile stays pure.
...
| Sibling worktree | May exist under `ai-shopify-superapp-phase11-*` — not merged until PR lands |

## Acceptance (from migration plan)

See Phase 11 in [`platform-v2-migration-plan.md`](../../docs/gitbook/02-architecture/platform-v2-migration-plan.md) for full acceptance criteria.
