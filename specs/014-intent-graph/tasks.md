# Tasks: Phase 14 — Intent Graph And Recipe DSL
...
- [x] T001 Review Phase 14 acceptance criteria in migration plan
...
- [ ] T004 Implement phase deliverables — **scaffold only**; in-memory intent graph scaffold; DSL acceptance open
