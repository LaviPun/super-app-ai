...
export type ActivityAction =
  ...
  | 'AI_ASSISTANT_QUERY'
  | 'AI_ASSISTANT_TOOL_CALLED'
  | 'ROUTER_RELEASE_GATE_TRIPPED'
  | 'PROVIDER_UPDATED'
  | 'PROVIDER_DELETED'
  ...
  | 'MODEL_PRICE_DELETED'
  | 'MODULE_DUPLICATED'
  // Support ticket system + CRM
  | 'SUPPORT_TICKET_CREATED'
  | 'SUPPORT_TICKET_SHOPPER_CREATED'
  | 'SUPPORT_TICKET_REPLY'
  | 'SUPPORT_TICKET_ESCALATE'
  | 'SUPPORT_TICKET_RESOLVE'
  | 'SUPPORT_TICKET_REOPEN'
  | 'SUPPORT_TICKET_RETRY_TRIAGE'
  | 'SUPPORT_TICKET_REPLIED'
  | 'SUPPORT_NOTE_ADDED'
  | 'SUPPORT_INTERVENTION_FLAGGED'
  | 'SUPPORT_TICKET_STATUS_CHANGED'
  | 'SUPPORT_TICKET_ASSIGNED'
  | 'SUPPORT_FIX_PROPOSED'
  | 'SUPPORT_FIX_APPLIED'
