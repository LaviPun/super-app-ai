...
const STYLE_CONFIG: Record<StyleableType, TypeStyleConfig> = {
  // Generic storefront section. Overlay/popup controls (backdrop, layout mode,
  // anchor, offset, z-index) are available but not forced, so the same preset
  // serves in-page sections and overlay/popup kinds alike.
  'theme.section': {
