...
CREATE TABLE "FlowDeadLetter" (
    ...
    CONSTRAINT "FlowDeadLetter_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ShopApiRateLimit" (
    "id" TEXT NOT NULL,
    "shopId" TEXT NOT NULL,
    "currentlyAvailable" DOUBLE PRECISION,
    "maximumAvailable" DOUBLE PRECISION,
    "restoreRate" DOUBLE PRECISION,
    "lastQueryCost" DOUBLE PRECISION,
    "totalCalls" INTEGER NOT NULL DEFAULT 0,
    "throttledCount" INTEGER NOT NULL DEFAULT 0,
    "lastThrottledAt" TIMESTAMP(3),
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "ShopApiRateLimit_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ImageIngestionJob" (
    ...
    CONSTRAINT "ImageIngestionJob_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ModuleSettingsValues" (
    ...
    CONSTRAINT "ModuleSettingsValues_pkey" PRIMARY KEY ("instanceId","revisionId")
);
...
CREATE TABLE "FunctionRuleSet" (
    ...
    CONSTRAINT "FunctionRuleSet_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ModuleMetricsDaily" (
    ...
    CONSTRAINT "ModuleMetricsDaily_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "InternalAiSession" (
    ...
    CONSTRAINT "InternalAiSession_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "InternalAiMessage" (
    ...
    CONSTRAINT "InternalAiMessage_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "InternalAiMemory" (
    ...
    CONSTRAINT "InternalAiMemory_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "InternalAiToolAudit" (
    ...
    CONSTRAINT "InternalAiToolAudit_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "SupportFixProposal" (
    ...
    CONSTRAINT "SupportFixProposal_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Shop" ADD CONSTRAINT "Shop_aiProviderOverrideId_fkey" FOREIGN KEY ("aiProviderOverrideId") REFERENCES "AiProvider"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Module" ADD CONSTRAINT "Module_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Module" ADD CONSTRAINT "Module_recipeId_fkey" FOREIGN KEY ("recipeId") REFERENCES "Recipe"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Connector" ADD CONSTRAINT "Connector_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConnectorEndpoint" ADD CONSTRAINT "ConnectorEndpoint_connectorId_fkey" FOREIGN KEY ("connectorId") REFERENCES "Connector"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "AiUsage" ADD CONSTRAINT "AiUsage_providerId_fkey" FOREIGN KEY ("providerId") REFERENCES "AiProvider"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ErrorLog" ADD CONSTRAINT "ErrorLog_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AiModelPrice" ADD CONSTRAINT "AiModelPrice_providerId_fkey" FOREIGN KEY ("providerId") REFERENCES "AiProvider"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ApiLog" ADD CONSTRAINT "ApiLog_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "FlowStepLog" ADD CONSTRAINT "FlowStepLog_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AppSubscription" ADD CONSTRAINT "AppSubscription_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RetentionPolicy" ADD CONSTRAINT "RetentionPolicy_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ThemeProfile" ADD CONSTRAINT "ThemeProfile_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "FlowSchedule" ADD CONSTRAINT "FlowSchedule_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FlowDeadLetter" ADD CONSTRAINT "FlowDeadLetter_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ShopApiRateLimit" ADD CONSTRAINT "ShopApiRateLimit_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DataStore" ADD CONSTRAINT "DataStore_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "WorkflowDef" ADD CONSTRAINT "WorkflowDef_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Shop"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "WorkflowRun" ADD CONSTRAINT "WorkflowRun_workflowId_workflowVersion_tenantId_fkey" FOREIGN KEY ("workflowId", "workflowVersion", "tenantId") REFERENCES "WorkflowDef"("workflowId", "version", "tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ConnectorToken" ADD CONSTRAINT "ConnectorToken_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Shop"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ModuleAsset" ADD CONSTRAINT "ModuleAsset_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ImageIngestionJob" ADD CONSTRAINT "ImageIngestionJob_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ImageIngestionJob" ADD CONSTRAINT "ImageIngestionJob_moduleId_fkey" FOREIGN KEY ("moduleId") REFERENCES "Module"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ModuleInstance" ADD CONSTRAINT "ModuleInstance_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ModuleInstance" ADD CONSTRAINT "ModuleInstance_moduleId_fkey" FOREIGN KEY ("moduleId") REFERENCES "Module"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ModuleInstance" ADD CONSTRAINT "ModuleInstance_revisionId_fkey" FOREIGN KEY ("revisionId") REFERENCES "ModuleVersion"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ModuleSettingsValues" ADD CONSTRAINT "ModuleSettingsValues_instanceId_fkey" FOREIGN KEY ("instanceId") REFERENCES "ModuleInstance"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ModuleSettingsValues" ADD CONSTRAINT "ModuleSettingsValues_revisionId_fkey" FOREIGN KEY ("revisionId") REFERENCES "ModuleVersion"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DataCapture" ADD CONSTRAINT "DataCapture_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DataCapture" ADD CONSTRAINT "DataCapture_instanceId_fkey" FOREIGN KEY ("instanceId") REFERENCES "ModuleInstance"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DataCapture" ADD CONSTRAINT "DataCapture_moduleId_fkey" FOREIGN KEY ("moduleId") REFERENCES "Module"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FunctionRuleSet" ADD CONSTRAINT "FunctionRuleSet_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FunctionRuleSet" ADD CONSTRAINT "FunctionRuleSet_moduleId_fkey" FOREIGN KEY ("moduleId") REFERENCES "Module"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FlowAsset" ADD CONSTRAINT "FlowAsset_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FlowAsset" ADD CONSTRAINT "FlowAsset_moduleId_fkey" FOREIGN KEY ("moduleId") REFERENCES "Module"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ModuleEvent" ADD CONSTRAINT "ModuleEvent_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ModuleEvent" ADD CONSTRAINT "ModuleEvent_instanceId_fkey" FOREIGN KEY ("instanceId") REFERENCES "ModuleInstance"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ModuleMetricsDaily" ADD CONSTRAINT "ModuleMetricsDaily_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ModuleMetricsDaily" ADD CONSTRAINT "ModuleMetricsDaily_instanceId_fkey" FOREIGN KEY ("instanceId") REFERENCES "ModuleInstance"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AttributionLink" ADD CONSTRAINT "AttributionLink_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "InternalAiMessage" ADD CONSTRAINT "InternalAiMessage_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "InternalAiSession"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "InternalAiToolAudit" ADD CONSTRAINT "InternalAiToolAudit_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "InternalAiSession"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "InternalAiToolAudit" ADD CONSTRAINT "InternalAiToolAudit_messageId_fkey" FOREIGN KEY ("messageId") REFERENCES "InternalAiMessage"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "SupportFixProposal" ADD CONSTRAINT "SupportFixProposal_ticketId_fkey" FOREIGN KEY ("ticketId") REFERENCES "SupportTicket"("id") ON DELETE CASCADE ON UPDATE CASCADE;
